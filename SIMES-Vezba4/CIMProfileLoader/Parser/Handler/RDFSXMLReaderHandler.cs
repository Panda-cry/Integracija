...
namespace FTN.ESI.SIMES.CIM.Parser.Handler
{
    class RDFSXMLReaderHandler : IHandler
    {
        ...
        private int couterPackets;
        private int CounterClass { get; set; }
        private static SortedList<string, string> prop = new SortedList<string, string>();
        #region Properties User
        
        public int CounterPackets
        {
            get { return couterPackets; }
            set { couterPackets = value; }
        }
        #endregion
        /// <summary>
        ...
        public void EndDocument()
        {
            if (profile != null)
            {
                ...
                profile.CountersClasses = CounterClass;
                profile.CountersPacket = CounterPackets;
