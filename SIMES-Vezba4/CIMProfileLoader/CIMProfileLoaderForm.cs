    ...
    public partial class CIMProfileLoaderForm : Form
    {
        ...
        private void PrintProfile()
        {
            ...
            if (profile != null)
            {
                ...
                classCounter.Text = profile.CountersClasses.ToString();


                packetCounter.Text = profile.CountersPacket.ToString();
            }
        }
        ...
        private void packetCounter_TextChanged(object sender, EventArgs e)
        {
