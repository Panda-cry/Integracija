...
namespace TelventDMS.Services.NetworkModelService.TestClient.Tests
{
	...
	{			
        ...
        public List<long> GetExtentValuesPowerTranformer(ModelCode modelCode)
        {
            string message = "Getting extent values method started.";
            Console.WriteLine(message);
            CommonTrace.WriteTrace(CommonTrace.TraceError, message);
            ...
            try
            {
                ...
                xmlWriter = new XmlTextWriter(Config.Instance.ResultDirecotry + "\\GetExtentValues_ResultsPowerTransformer.xml", Encoding.Unicode);
                xmlWriter.Formatting = Formatting.Indented;
        ...
        public List<long> GetRelatedValuesTransformer(long sourceGlobalId, Association association)
        {
            string message = "Getting related values method started.";
            Console.WriteLine(message);
            CommonTrace.WriteTrace(CommonTrace.TraceError, message);
            ...
            try
            {
                ...
                xmlWriter = new XmlTextWriter(Config.Instance.ResultDirecotry + "\\GetRelatedValues_ResultsTransformer.xml", Encoding.Unicode);
                xmlWriter.Formatting = Formatting.Indented;
